...
defmodule ICouchTest do
  ...
  test "server connection" do
    ...
    assert ICouch.server_connection("http://admin:admin@192.168.99.100:8400/") === %ICouch.Server{
      direct: nil, ib_options: [basic_auth: {'admin', 'admin'}], timeout: nil,
      uri: %URI{authority: "192.168.99.100", fragment: nil, host: "192.168.99.100",
        path: "/", port: 8400, query: nil, scheme: "http", userinfo: nil}}
  end
